...
class Toplevel1:
     def __init__(self, top=None):
          ...
          self.WebcamOn_var=tk.BooleanVar()
          self.DefineOn_var=tk.BooleanVar()
          self.TrafikOn_var=tk.BooleanVar()
          self.PolisenOn_var=tk.BooleanVar()
          ...
          self.TrafikOn = tk.Checkbutton(self.Labelframe1)
          self.TrafikOn.place(x=0, y=50, height=20, width=100)
          self.TrafikOn.configure(text="Traffic")
          self.TrafikOn.configure(anchor="w")
          self.TrafikOn.configure(offvalue=False)
          self.TrafikOn.configure(onvalue=True)
          self.TrafikOn.configure(variable=self.TrafikOn_var)
          self.TrafikOn.configure(command=lambda:MyTelegramBotGUI_support.Check_Press("TrafficOn"))
          ...
          self.PolisenOn = tk.Checkbutton(self.Labelframe1)
          self.PolisenOn.place(x=100, y=50, height=20, width=100)
          self.PolisenOn.configure(text="Police")
          self.PolisenOn.configure(anchor="w")
          self.PolisenOn.configure(offvalue=False)
          self.PolisenOn.configure(onvalue=True)
          self.PolisenOn.configure(variable=self.PolisenOn_var)
          self.PolisenOn.configure(command=lambda:MyTelegramBotGUI_support.Check_Press("PolisenOn"))
          ...
          self.PolisenOn = tk.Checkbutton(self.Labelframe1)
          self.PolisenOn.place(x=200, y=50, height=20, width=100)
          self.PolisenOn.configure(text="Map")
          self.PolisenOn.configure(anchor="w")
          self.PolisenOn.configure(offvalue=False)
          self.PolisenOn.configure(onvalue=True)
          self.PolisenOn.configure(variable=self.MapOn_var)
          self.PolisenOn.configure(command=lambda:MyTelegramBotGUI_support.Check_Press("MapOn"))
          
          self.WebcamOn = tk.Checkbutton(self.Labelframe1)
          self.WebcamOn.place(x=300, y=10, height=20, width=100)
          self.WebcamOn.configure(text="Webcam")
          self.WebcamOn.configure(anchor="w")
          self.WebcamOn.configure(offvalue=False)
          self.WebcamOn.configure(onvalue=True)
          self.WebcamOn.configure(variable=self.WebcamOn_var)
          self.WebcamOn.configure(command=lambda:MyTelegramBotGUI_support.Check_Press("WebcamOn"))
